...
import com.ardikars.jxpacket.ip.ipv6.Fragment;
import com.ardikars.jxpacket.ip.ipv6.HopByHopOptions;
import com.ardikars.jxpacket.ip.ipv6.Routing;
    ...
    public Packet decode(final ByteBuffer buffer) {
        ...
        switch (value) {
            ...
            case 2:
                return null;
            case 6:
                return com.ardikars.jxpacket.tcp.TCP.newInstance(buffer);
            case 17:
                return com.ardikars.jxpacket.udp.UDP.newInstance(buffer);
            default:
                return null;
        }
    }
