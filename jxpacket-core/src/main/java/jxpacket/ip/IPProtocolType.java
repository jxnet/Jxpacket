...
import jxpacket.icmp.ICMPv4;
import jxpacket.icmp.ICMPv6;
import jxpacket.ip.ipv6.EncapsulatingSecurityPayload;
import jxpacket.ip.ipv6.Fragment;
import jxpacket.ip.ipv6.HopByHopOptions;
import jxpacket.ip.ipv6.Routing;
    ...
    public Packet decode(final ByteBuffer buffer) {
        ...
        switch (value) {
            ...
            case 2:
                return null;
            case 6:
                return jxpacket.tcp.TCP.newInstance(buffer);
            case 17:
                return jxpacket.udp.UDP.newInstance(buffer);
            default:
                return null;
        }
    }
