...
public class OpeningBalance implements com.ardikars.jxpacket.mt940.OpeningBalance {
    ...
    public OpeningBalance(CreditOrDebit creditOrDebit, Date statementDate, Currency currency, BigDecimal amount) {
    ...
    @Builder
    public static OpeningBalance newInstance(String creditOrDebitMark, String statementDate, String currency, String amount) {
